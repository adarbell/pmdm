...
public class PeliculaDBHelper {
    ...
    // tabla y campos
    private static final String DATABASE_TABLE_PELICULAS = "peliculas";
    ...
    private static final String DATABASE_CREATE_PELICULAS =
            "create table "+ DATABASE_TABLE_PELICULAS + " (" +
    ...
    //constructor
    public PeliculaDBHelper(Context ctx) {
        this.mCtx = ctx;
    }
    ...
    private static class DataBaseHelperInternal extends SQLiteOpenHelper {
        ...
        private void createTables(SQLiteDatabase db) {
            db.execSQL(DATABASE_CREATE_PELICULAS);
        }

        private void deleteTables(SQLiteDatabase db) {
            db.execSQL("DROP TABLE IF EXISTS " + DATABASE_TABLE_PELICULAS);
        }
    }

    public PeliculaDBHelper open()  {
    ...
    public Cursor getItems() {
        ...
        return mDb.query(DATABASE_TABLE_PELICULAS, new String[] {SL_ID, SL_TITULO, SL_AUTOR, SL_SINOPSIS, SL_USERID}, null, null, null, null, SL_ID);
    }

    public Cursor getItemsFrom(int userid) {
        //Parametros:nombreTabla,campos,campoWhere,condicionWhere,Group By, Havong, Order by
        return mDb.query(DATABASE_TABLE_PELICULAS, new String[] {SL_ID, SL_TITULO, SL_AUTOR, SL_SINOPSIS, SL_USERID}, "user_id = " + userid, null, null, null, SL_ID);
    }
    ...
    public long insertItem(String titulo, String autor, String sinopsis, String userid){
        ...
        return mDb.insert(DATABASE_TABLE_PELICULAS, null, initialValues);
    }
}
